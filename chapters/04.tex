...
\section{Propositional logic}\label{sec:4.2}
\subsection{Propositional operators}\label{sec:4.2.1}
...
\subsection{Meaning relations and rules of inference}\label{sec:4.2.2}
...
\subsection{Quantifiers (an introduction)}\label{sec:4.3.1}
...
\subsection{Scope ambiguities}\label{sec:4.3.2}
...
\section{Conclusion}\label{sec:4.4}
