...
\ea \label{ex:20.1}
{Lithuanian tense marking} (\citealt{ChungTimberlake1985}: 204)\\
\ea 
\gll dirb-\textit{au}\\
...
\ea \label{ex:20.17}
\ea
\begin{tabularx}{\textwidth}{lllS}
         & \underline{[  TT  ]}  & {\textbar}    & [\ref{ex:20.16}a; \textsc{imperfective aspect}]\\                       
         \cline{1-3}
  & …===TSit===… &  TU  & 
\end{tabularx}
  \ex
\begin{tabularx}{\textwidth}{lllS}
         & \underline{[  TT  ]}  & {\textbar}    & [\ref{ex:20.16}a; \textsc{perfective aspect}]\\                       
         \cline{1-3}
    &{\textbar}=TSit=\textbf{\textbar}&    TU & 
\end{tabularx}
\z
\z
...
\ex \textit{be happy}
\ex \textit{wake up}
\ex \textit{snap your fingers}
\ex \textit{compose a sonnet}
\ex \textit{swim the English channel}
\ex \textit{drink coffee}
\ex \textit{drink two cups of coffee}
\ex \textit{expire} (e.g., visa, passport, etc.)
\ex \textit{own} (e.g., \textit{John owns a parrot})
\z
\z
}
...
\modelanswer{Model answer}{\textit{have}\\
\begin{enumerate}
...
\z
\ea 
{Horace played Beethoven’s Pathétique sonata}.
\z
\ea 
...
\ea
As I walked through his door, \textit{I was instantly aware} of the quiet strength of mind Buzz possesses\footnote{\url{http://www.vvoice.org/?module=displaystory&story_id=3725&format=html}}
\z
\ea 
William recited the \textit{Iliad} for a few minutes.
\z
\ea 
John knocked on the door for ten minutes.
\z
\ea 
The children of Atuler village in Sichuan have for many years been climbing  up a sheer 800 meter cliff on rattan ladders in order to attend school.
\z
}