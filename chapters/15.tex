...
\ea \label{ex:15.2}
\ea \label{ex:15.} Mary believes [that \textit{The Prince and the Pauper} was written by Mark Twain].\\
...
\ea \label{ex:15.21}
(spoken in 2006)\\
\ea \label{ex:15.} Barack Obama is the first black President of the United States. \hfill  [F]\\
...
\ea \label{ex:15.22}
(spoken in 2006)\\
\ea \label{ex:15.} Barack Obama is not the first black President of the United States. \hfill [T]\\
