...
A very interesting use of this principle occurs in the short story “Xingu”, by Edith Wharton (1916). In the following passage, Mrs. Roby is describing something to the members of her ladies’ club, which they believe (and which she allows them to believe) to be a deep, philosophical book. After the discussion is over, however, the other members discover that she was actually describing a river in Brazil. The words which are bolded below are ambiguous; all of them must be interpreted with one sense in a discussion of a philosophical work, but another sense in a discussion of a river.

% \todo[inline]{underlining emphasis gone missing here}
\ea \label{ex:5.17}
“Of course,” Mrs. Roby admitted, “the difficulty is that one must give up so much time to it. It’s very \textbf{long}.”\\
“I can’t imagine,” said Miss Van Vluyck tartly, “grudging the time given to such a subject.”\\
“And \textbf{deep} in places,” Mrs. Roby pursued; (so then it was a book!) “And it isn’t easy to \textbf{skip}.”\\
“I never skip,” said Mrs. Plinth dogmatically.\\
“Ah, it’s dangerous to, in Xingu. Even at the start there are places where one can’t. One must just \textbf{wade} through.”\\
“I should hardly call it wading ,” said Mrs. Ballinger sarcastically.\\
Mrs. Roby sent her a look of interest. “Ah — you always found it went \textbf{swimmingly}?”\\
Mrs. Ballinger hesitated. “Of course there are difficult \textbf{passages},” she conceded modestly.\\
“Yes; some are not at all \textbf{clear} — even,” Mrs. Roby added, “if one is familiar with the \textbf{original}.\footnote{Apparently a play upon an archaic sense of \textit{original} meaning ‘source’ or ‘origin’.}”\\
“As I suppose you are?” Osric Dane interposed, suddenly fixing her with a look of challenge.\\
Mrs. Roby met it by a deprecating smile. “Oh, it’s really not difficult up to a certain point; though some of the \textbf{branches} are very little known, and it’s almost impossible to get at the \textbf{source}.”
\z
...
\ea
\ea \textit{bead} (< ‘prayer’)\\
\ex \textit{pastor}\\
\ex \textit{drumstick} (for ‘turkey leg’)\\
\ex \textit{glossa} (Greek) ‘tongue; language’\\
\ex \textit{pioneer} (< Old French \textit{peon(ier)} ‘foot-soldier’; cognate: \textit{pawn})
\z
\z
}
