...
\ex Create a model under which sentences (\ref{ex:13.}b--c) will be false, and the rest (including (\ref{ex:13.}a)) will be true.\footnote{Patterned loosely after \citet[350]{Saeed2009}.}
\z
\z
