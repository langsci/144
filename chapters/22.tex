...
\ea \label{ex:22.2}
\ea I {have been standing} in this line for the past four hours.\\
...
\ea \label{ex:22.8}
\ea George left for Paris {yesterday/last week}.\\
...
\ea \label{ex:22.9}
\ea I have {now} built hospitals on five continents.\\
...
\ea \label{ex:22.10}
\ea {Having eaten} a whole pizza last night, I skipped breakfast this morning.\\
...
\ea \label{ex:22.11}
\ea {Having lived} in Tokyo since 1965, I know the city fairly well.\\
...
\ea  Arthur’s theft of government documents was discovered on May 21\textsuperscript{st}, but he {had left} \\
...
\ea \label{ex:22.23}
\ea I have loved Charlie Chaplin ever since I saw {Modern Times}.\\
...
\textsc{S:3.m}  cough  \textsc{pfv}  \textsc{prtcl}  time  one\\
\glt ‘He coughed once.’
\ex \glll  \#kà  asːe    ātːá  pańi\'{ŋ}\\
  kà  ásː-  -ē  ātːá  pańi\'{ŋ}\\
\textsc{S:3.m}  cough  \textsc{prf}  time  one\\
\z \z
...
\textsc{S:3.m}  go  \textsc{pfv}  and  \textsc{S:3.m}  return  \textsc{prf}\\
\glt ‘He left but he has returned (and is still here).’
\ex \glll   kà  kólá    wò  kà  láawá    tā\\
kà  kól-  -à  wò  kà  láaw-  -à  tā\\
\textsc{S:3.m}  go  \textsc{pfv}  and  \textsc{S:3.m}  return  \textsc{pfv}  \textsc{prtcl}\\
...
\ea  \glll kà  mótē\\
kà  mót-  -ē\\
\textsc{S:3.m}  die  \textsc{prf}\\
\glt ‘He died.’
\ex \glll ?ka  mota\\
 kà  mót-  -à\\
\textsc{S:3.m}  die  \textsc{pfv}\\
...
\textsc{S:3.m}  die  \textsc{pfv}  \textsc{prtcl}  and  \textsc{S:3.m}  resurrect  \textsc{prf}\\
\glt ‘He died, but he has been resurrected.’
\ex \glll  \#ka  mote    wo  ka  ɲire\\
  kà  mót-  -ē  wò  kà  ɲi\={r}  -ē\\
\textsc{S:3.m}  die  \textsc{prf}  and  \textsc{S:3.m}  resurrect  \textsc{prf}\\
...
\textsc{3sg}  love  Huang  Miss \textsc{prtcl} now  still  love-\textsc{cont}  there  \textsc{prtcl}\\
\glt ‘He has fallen in love with Miss Huang (and he still loves her now).’  (\citealt{Ma1977}: 18)
\z \z


Interestingly, this discontinuity requirement is (partially?) dependent on the definiteness of the affected argument (\citealt{Lin2007}; \citealt{Wu2008}; \citealt{Chen2009}). When the patient is definite, as in (\ref{ex:22.39}a), the use of \textit{–guo} indicates that the result state no longer obtains; but when the patient is indefinite, as in (\ref{ex:22.39}b), there is no such implication/entailment.
...
It is useful to compare the semantic effect of the aspectual suffix \textit{–guo} in various situation types (\textit{Aktionsart}). With stative predicates, \textit{–guo} indicates that the state no longer exists \REF{ex:22.43}. Therefore, permanent states cannot normally be marked with \textit{–guo} \REF{ex:22.44}.
...
With atelic events such as activities \REF{ex:22.45} and non-culminating accomplishments \REF{ex:22.46}, the suffix -\textit{guo} has the same interpretation as the perfective suffix \textit{–le}, indicating that the event has terminated.
...
\ea \label{ex:22.47}
\ea \gll *Tā  shā-sǐ-guo  nèi-ge  rén.\\
...
\textsc{1sg}  die-\textsc{pfv} quite.a.few.times\\
...
\usecounter{equation}\setcounter{equation}{0}
...
\glt ‘Maybe this afternoon I will try to play ping-pong for the first time.’   [\citealt{Verhaar} 153]
\z
...
\glt ‘If you eat many peanuts, you will become strong like the phantom.’[\citealt{Wohlgemuth}]
\z
...
\glt ‘At night I sleep, and then the mosquitoes come into my house.’   [\citealt{Verhaar}]
\z
...
\glt ‘They are/were eating.’  [\citet{Verhaar} 107]
\z
...
\glt ‘The door was just open like that…’  [\citealt{Verhaar} 108]
\z

\ea 
\gll Em  i tisa  i \textit{stap}  yet.\\
\textsc{3sg}  \textsc{pred} teacher  \textsc{pred  aux}  still\\
...
\glt ‘How many days has the child been sick?’  [\citealt{Verhaar}  108]
\z

\ea 
\gll  Taim  em  i  kam  i lukim  Dogare\\
time  \textsc{3sg}  \textsc{pred}  come  \textsc{pred}  see  (name)\\
\z
...
\ea \gll  {Bai}  sampela  ol  i  toktok  i {stap}  na\\
...
\glt ‘Some of them will be talking and not listen well to your speech.’ [\citealt{Wohlgemuth}]
\z
...
\glt ‘We [excl.] have built some houses.’  [\citealt{Verhaar}]
\z

\ea 
\gll  Gavman  i  putim  \textit{pinis}  planti  didiman.\\
government  \textsc{pred} place  \textsc{aux}  many  agricultural.officer\\
\glt ‘The government has appointed many agricultural officers.’   [\citealt{Verhaar}]
\z

\ea 
\gll  Dok  i  dai  \textit{pinis}.\\
dog  \textsc{pred}  die  \textsc{aux}\\
\glt ‘The dog has died/is dead.’   [\citealt{Verhaar}]
\z

\ea 
\gll  Mi  lapun  \textit{pinis}.\\
\textsc{1sg}  old.person  \textsc{aux}\\
\glt ‘I am already old.’ Or: ‘I have grown old.’   [\citealt{Verhaar}]
\z

\ea \ea 
\gll a. Ol  i  bikpela  \textit{pinis}.\\
3pl  \textsc{pred}  big  \textsc{aux}\\
\glt ‘They have become big/are grown-ups (now).’   [\citealt{Verhaar} 117]
...
\glt ‘Has the pain been there for a long time, or has it just started?  [\citealt{Verhaar}]
\z
...
\glt ‘He had become a major by the time we [excl.] heard this story.’   [\citealt{Verhaar}]
\z
