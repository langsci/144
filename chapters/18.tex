...
\ea {Mrs. Thatcher will not win because she is a woman}. (spoken in 1979)
\z
\ea
Tourists rarely visit Delhi because the food is so spicy.
\z
\ea 
{I doubt that Peter is happy because he was fired.}
\z
...
\ea
{Arthur works for the State Department, because he has a STATE.GOV e-mail address}.
\z
\ea 
{Oil prices are rising, because OPEC has agreed to cut production}.
\z
}
\homeworkexercises{
...
\ea
{Steve Jobs didn’t start Apple because he loved technology}\footnote{https://www.fastcompany.com/3001441/do-steve-jobs-did-dont-follow-your-passion}
\z
\ea 
{Arnold must have sold his Jaguar because I saw him driving a minivan}.
\z
\ea 
{Few Texans voted for Romney because he is a Mormon}.
\z
\ea 
{Susan believes that A.G. Bell was rich because he invented the telephone}.
\z
}