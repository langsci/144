...
\citet[ch. 4]{Birner20122013} provides a helpful overview of reference and various related issues.



\citet[ch. 2]{Abbott2010} provides a good summary of early work by Frege and other philosophers on the distinction between sense and denotation; later chapters provide in-depth discussions of various types of referring expressions. 



For additional discussion of expressive meaning see \citet{Cruse1986,Cruse2000,Potts2007b}, and \citet{Kratzer1999}.
...
% {\small 
% \ea
% \ea \parbox{5.5cm}{\textit{cordates} (= ‘animals with hearts’) } \textit{renates} (= ‘animals with kidneys’)\\               
% \ex \parbox{5.5cm}{\itshape animals with gills and scales } {\itshape fish}\\
% \ex \parbox{5.5cm}{\itshape your first-born son } {\itshape your oldest male offspring}\\
% \ex \parbox{5.5cm}{\itshape Ronald Reagan } {\itshape the Governor of California}\\
% \ex \parbox{5.5cm}{\itshape my oldest sister } {\itshape your Aunt Betty}\\
% \ex \parbox{5.5cm}{\itshape my pupils } {\itshape the students that I teach}\\
% \ex \parbox{5.5cm}{\textit{the man who invented the phonograph} } \textit{the man who invented the light-bulb}\\
% \z\z
% }
\\\medskip

\kroegertriple{a.}{\small cordates (= ‘animals with hearts’)}{\small renates (= ‘animals with kidneys’)}               
\kroegertriple{b.}{\small animals with gills and scales}{\small fish}
\kroegertriple{c.}{\small your first-born son}{\small your oldest male offspring}
\kroegertriple{d.}{\small Ronald Reagan}{\small the Governor of California}
\kroegertriple{e.}{\small my oldest sister}{\small your Aunt Betty}
\kroegertriple{f.}{\small my pupils}{\small the students that I teach}
\kroegertriple{g.}{\small the man who invented the phonograph}{\small the man who invented the light-bulb}
...
For each of the following sentences, state whether or not the nominal expression in bold is being used to refer.

\begin{enumerate}[label=\alph*.]
\item Abraham Lincoln was very close to \textbf{his step-mother}.\\{}
  \modelanswer{Model answer}{The phrase \textit{his step-mother} is used to refer to a specific person,\\
  namely {Sarah Bush} Lincoln, so it does refer}
\item  I’m so hungry I could eat \textbf{a horse}.
\item  {Senate Majority Leader Curt Bramble, R-Provo, was back in the hospital this weekend after getting} kicked by \textbf{a horse}. [Provo, UT \textit{Daily Herald} Jan. 29, 2007]
