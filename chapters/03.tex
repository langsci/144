...
\ea {If that snake is not dead then it is alive}.
\z

\ea {Shanghai is the capital of China}.
\z

\ea {My brother is an only child}.
\z

\ea {Abraham Lincoln was the 16\textsuperscript{th}} {president of the United States}. 
\z
\paragraph*{B: Relationships between propositions}
...
\ea%5 
\ea {Lief Ericson returned to Greenland}.\\
\ex {Lief Ericson had previously visited Greenland}.
    \z
\z
}