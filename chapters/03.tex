...
\citet[ch. 5]{Birner2013}. \citet{Potts2015} also provides a good summary, including a comparison of presuppositions with conventional implicatures (which we will discuss in chapters \ref{sec:8} and \ref{sec:11}). \Citep[sec. 4.1]{vonFintelMatthewson2008} discuss cross-linguistic issues.
}
